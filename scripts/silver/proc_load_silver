...
================================================================================
Script Purpose:
    This stored procedure loads data into the 'silver' schema from the bronze
    layer.
...
BEGIN
	...
	BEGIN TRY
		...
		PRINT '>> Silver Layer Loaded in: ' + CAST(DATEDIFF(second, @start_silver, @end_silver) AS NVARCHAR) + ' seconds';
